<?php
  ...
  function ConsultarProducto( $id_comp )
  {
   ...
   $sentencia="SELECT * FROM huertas WHERE id='".$id_comp."' ";
...
<html>
  ...
  <body>
      ...
      <div class="container">
            <div class="header">
                <a href="index.php"><strong>&lt;&lt;Volver </strong></a>
                <span class="right">         
            ...
            <h1>Modificar Huerta <span>Panel de administracion </span></h1>
                ...
                <div class="todo">                        
                        <div id="contenido">
                          ...
                          <form action="modif_prod2.php" method="POST" style="border-collapse: separate; border-spacing: 10px 5px;">
                            ...
                            <input type="text" id="localizacion" name="localizacion" value="<?php echo $consulta[1] ?>"><br>
                            <br>
                            <label>Fruta: </label><br>
                            <input type="text" id="fruta" name="fruta" value="<?php echo $consulta[2] ?>"><br>
                            <br>
                            <label>Hectareas sembradas: </label><br>
                            <input type="text" id="hectareas" name="hectareas" value="<?php echo $consulta[3] ?>"><br>
                            <br>
