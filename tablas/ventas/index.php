  ...
  <br><p><a href="../../login/admin.php"><img src="../../img/logo-admin.png" alt="logo" id="logo"></a></p><br>
      ...
      <div class="container">
          ...
          <a href="../../login/salir.php">Salir</a>
            ...
            <h1>Lista de ventas <span>Tabla ventas </span></h1>
            <div class="content">
                <div id="contenido">
                  <br>
    <table id="tabla"style="margin: auto; width: 1200px; border-collapse: separate; border-spacing: 10px 5px;">
      <thead>
        <th>ID Venta</th>
        <th>Fruta</th>
        <th>Calidad</th>
      ...
      <?php
        ...
        while($fila=$resultado->fetch_assoc())
        {
          echo "<tr>";
            ...
            echo "<td>"; echo $fila['calidad']; echo "</td>";
            echo "<td>"; echo $fila['cantidad']; echo "</td>";
            echo "<td>"; echo $fila['origen']; echo "</td>";
            echo "<td>"; echo $fila['pago']; echo "</td>";
            echo "<td>"; echo $fila['precio_unitario']; echo "</td>";
            echo "<td>"; echo $fila['comprador']; echo "</td>";
            echo "<td>"; echo "$", $fila['total']; echo "</td>";
